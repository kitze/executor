...
import { FormElicitation, ToolAddress } from "@executor-js/sdk/core";
...
describe("formatPausedExecution approval terms", () => {
  const paused = (request: FormElicitation) =>
    ({
      id: "exec_1",
      elicitationContext: { address: ToolAddress.make("tools.x.org.default.y"), request },
    }) satisfies Parameters<typeof formatPausedExecution>[0];
